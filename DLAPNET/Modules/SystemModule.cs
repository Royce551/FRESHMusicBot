...
{
    [Name("System")]
    [Summary("Basic interaction with FRESHMusicBot")]
    public class SystemModule : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task Help(string search = null)
        {
            ...
            if (search is null)
            {
                ...
                await ReplyAsync(
                    ":information_source: **FRESHMusicBot Help**\n" +
            ...
            else
            {
                ...
                if (module is null)
                {
                    ...
                    await ReplyAsync(":information_source: **FRESHMusicBot Help**", embed: embedBuilder.Build());
                    return;
                }
                string summary = $"{module.Summary}\r\n\r\n";
        ...
        [Command("about")]
        [Summary("Gets information about FRESHMusicBot")]
        public async Task About()
        {
            var embedBuilder = MessagingUtils.GetShrimpbotEmbedBuilder();
            embedBuilder.ImageUrl = "https://cdn.discordapp.com/attachments/982700281047425114/982710807982907482/IMG_20220604_122051.jpg";
            ...
            embedBuilder.AddField("Links",
                "Official FRESHMusicBot Discord Server: https://discord.gg/fuJ6J4s\n");
            embedBuilder.WithFooter("Thank you for using FRESHMusicBot! ❤");
            await Client.CurrentUser.ModifyAsync(x => x.Username = Config.Name);
            await ReplyAsync(null, false, embedBuilder.Build());
        }
        [Command("uptime")]
        [Summary("Shows how long FRESHMusicBot has been up")]
        ...
        [Command("stats")]
        [Summary("Shows some interesting information about FRESHMusicBot")]
